          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  value={form.price ? `Rp ${form.price}` : ""}
                  onChange={(e) => {
                    const raw = e.target.value.replace(/[^0-9.]/g, "");
                    handlePriceChange(raw);
                  }}
                  placeholder="Rp 0"
                  className="w-full pl-10 pr-4 py-3 bg-white border border-[#D9D7EC] rounded-xl focus:outline-none focus:ring-1 focus:ring-purple-500 placeholder-gray-400 text-sm text-gray-900"
                />
              </div>
            </div>
            <div>
