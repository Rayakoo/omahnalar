...
export default function ProdukDetail() {
  ...
  const handleWhatsApp = () => {
    ...
    const msg = encodeURIComponent(`Halo, saya tertarik dengan produk ${produk.name}`);
    ...
    return (
      <div className="min-h-screen bg-page-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-brand-900">Produk tidak ditemukan</h2>
  ...
  return (
    <div className="min-h-screen bg-page-50 font-sans antialiased flex flex-col">
      <div className="max-w-6xl mx-auto w-full px-4 md:px-6 pt-24 md:pt-28">
        ...
        >
          <ArrowLeft className="w-4 h-4" /> Semua Produk
        </button>
      </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-auto pt-8">
              ...
              >
                ...
                Tanya Soal Produk via WhatsApp
              </button>
            </div>
          </div>
        </div>
