...
import { ChevronDown, ArrowRight, Pen, UserCheck, IdCard } from "lucide-react";
...
export default function DetectiveNamePage() {
  ...
  useEffect(() => {
    getCourseById(courseId).then((c) => {
      if (c) {
        setCourseImage(c.thumbnail_url || "");
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 right-0 h-1.5 bg-[#8b4513]" />
      ...
      <div className="max-w-md mx-auto">
        <div className="w-20 h-20 bg-[#e8dcc8] rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-[#c4a882]">
          <UserCheck className="w-8 h-8 text-[#8b4513]" />
        </div>
      ...
      {showPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#3c2415]/60 backdrop-blur-sm">
          ...
          >
            ...
            `}</style>
            <div className="absolute top-0 left-0 right-0 h-1 bg-[#8b4513] rounded-t-2xl" />
            ...
            <div className="text-center mb-5 pt-2">
              <div className="w-14 h-14 bg-[#e8dcc8] rounded-full flex items-center justify-center mx-auto mb-3 border-2 border-[#c4a882]">
                <IdCard className="w-5 h-5 text-[#8b4513]" />
              </div>
