...
const SOCIAL_ICONS = [
  ...
  },
  {
    ...
    href: "https://youtube.com/@omahnalar",
  },
];
...
export default function Footer() {
  ...
  const t = locale === "id" ? id.footer : en.footer;
  const links = FOOTER_LINKS_ID.map((group) => ({
    title: t[group.key],
    links: group.links.map((lk) => ({ key: lk, label: t[lk] })),
  }));
                    ...
                    return (
                      <li key={link.key}>
                        <a
                          ...
                          className="text-sm text-brand-100/70 hover:text-page-50 transition-colors"
                        >
                          {link.label}
                        </a>
                      </li>
