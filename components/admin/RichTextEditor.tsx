...
type ToolbarBtn = { icon: typeof Bold; cmd: string; title: string };
...
export default function RichTextEditor({ value, onChange, placeholder, minHeight = 200 }: Props) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm focus-within:border-[#9792EC] transition-all">
